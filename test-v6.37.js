...
async function test() {
  ...
  const stages = {
    ...
    characters: { xiaoG: { baseIdentity: { name: 'AgentX', species: 'Nirathian' }, profile: { name: 'AgentX' }, portraits: { frontal: 'test.jpg' } } },
    ...
    style: [{
      ...
      characterRef: 'AgentX: image://test.jpg', character: 'AgentX: Nirathian, 战士, 勇敢', action: '探索森林', dialogue: 'NONE',
