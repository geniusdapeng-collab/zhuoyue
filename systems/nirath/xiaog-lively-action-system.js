    ...
    this.actionLibrary = {
      ...
      hook: {
        ...
        mysterious: {
          ...
          actions: [
            // 动作1：探头观察 + 碎光反应 + 好奇落点
            'AgentX蹲下来，从磁丝草丛缝隙中探头，手指竖在嘴边做"嘘"的动作但嘴角忍不住上扬——一片孢子碎光落在他鼻尖上，他下意识皱了皱鼻子，眼睛眨了两下，瞳孔倒映着双恒星的金色光芒，像两粒融化的蜂蜜',
            // 动作2：拨弄指南针 + 磁丝反应 + 警觉落点
            'AgentX歪着头，一只手无意识地把玩指南针挂绳，挂绳缠在手指上三圈。磁丝树突然倾斜，指南针指针剧烈抖动——他手腕一缩，但手指还勾着挂绳没松开，停在半空。呼吸比平时快了半拍，嘴角抿成一条线又缓缓放松',
            // 动作3：倒退又前进 + 草叶反应 + 冲动落点
            'AgentX倒退两步，被眼前的景象惊到，脚跟蹭着地面发出细微声响。一片草叶拂过他手背，他本能地一缩，随即又忍不住往前蹭了两步，像只好奇的小猫——重心在脚尖和脚跟间快速切换，膝盖微弯蓄力'
          ],
          // v2.0：微表情升级为"下意识反应"
          microExpressions: [
        ...
        epic: {
          actions: [
            'AgentX双手叉腰，仰着头，故意摆出"我来探险了"的架势，但眼睛里的光芒出卖了他',
            'AgentX跳起来，双手在空中挥舞，落地时故意把地面踩出"咚"的一声',
            'AgentX把背包甩到胸前，双手抓着肩带，像捧着什么宝贝，一步步坚定地向前'
          ],
          microExpressions: [
            '下巴微抬，眼神坚定',
            '嘴角抿着，压抑不住笑意'
      ...
      development: {
        ...
        observe: {
          actions: [
            ...
            'AgentX蹲下来，把下巴搁在膝盖上，双手环抱小腿，像只受惊但好奇的小动物。脚边一颗碎石从岩缝中滑落，发出轻微的"嗒"声——他肩膀本能地一缩，抱膝的手臂收紧了半秒，随即缓缓放松。呼吸变浅，但节奏不乱，像在强迫自己保持镇定',
            // 动作2：后退防御 + 磁场嗡鸣反应 + 警觉落点
            'AgentX缓慢后退半步，脚跟蹭着地面发出细微声响，一只手无意识挡在身前。空气中突然传来一阵低频磁场嗡鸣，他的指尖微微颤抖了一下，停在半空，像被无形的琴弦拨动。眼睛快速眨了两下，瞳孔收缩——不是恐惧，是警惕',
            // 动作3：僵直观察 + 孢子落肩反应 + 迷幻落点
            'AgentX屏住呼吸，双手紧紧抱住胸前背包，身体僵在原地，只有眼睛在快速转动。一粒发光孢子缓缓落在他肩头发梢上，他眼角余光捕捉到，眉头微皱，头微微侧了一下——但很快克制住，继续保持观察姿态。呼吸比刚才更深，像在为某种决定积蓄氧气'
          ],
          microExpressions: [
        ...
        probe: {
          actions: [
            ...
            'AgentX试探性地向前一步，脚尖先落地，确认安全后才跟上脚跟，像只谨慎的小鹿。地面突然传来一阵轻微震颤——他停在半空的那只脚僵了一秒，脚踝微微抖动，像在选择"落下去"还是"收回来"。最终脚跟缓缓落下，比正常步态慢了半拍',
            // 动作2：伸手示意 + 磁场光丝反应 + 善意落点
            'AgentX伸出一只手，掌心向上，做出"我没有恶意"的姿态，但另一只手还抓着背包带不放。一道淡蓝紫磁场光丝飘过他的手背，汗毛本能地竖起——他手指微微蜷缩，但没有收回手。嘴角从紧张抿着慢慢放松，变成半信半疑的弧度',
            // 动作3：观察石子 + 孢子发光反应 +  wonder落点
            'AgentX歪着头，慢慢蹲下，从地上捡起一块发光的小石子，举到眼前对着双恒星观察。石子在光线下变幻颜色，他的瞳孔随着颜色变化微微收缩又放大——无意识的身体反应。嘴角不自觉上扬，像发现了宝藏的小孩'
          ],
          microExpressions: [
        ...
        approach: {
          actions: [
            ...
            'AgentX慢慢直起身，一只手垂在身侧，另一只手轻轻抬起，指尖微微发光（与磁场共振）。异兽身上传来的磁场温度比周围高了3度，他手腕内侧的皮肤感受到这种温差，手指本能地蜷缩又舒展——像试探水温。肩膀从紧绷慢慢沉下来，呼吸从胸腔降到腹部',
            // 动作2：站定仰望 + 光影变化反应 + 敬畏落点
            'AgentX向前走了三步，每一步都比上一步更稳，最后停在异兽面前，抬头仰望。双恒星的光影在异兽身上缓缓移动，AgentX的瞳孔随着光影变化微微收缩——不是恐惧，是被宏大震撼后的平静。嘴角微微张开，但没有发出声音，像想说什么又不知道从何说起',
            // 动作3：坐下平视 + 地面草叶反应 + 平等落点
            'AgentX盘腿坐在异兽面前的草地上，双手放在膝盖上，深呼吸三次，然后露出微笑。一片草叶蹭过他小腿，他低头看了一眼，但没有拨开——让草叶留在那里，像接受Nirath的一个小小拥抱。坐姿微微歪斜，不是刻意的礼貌，是放松后的自然'
          ],
          microExpressions: [
        ...
        resonate: {
          actions: [
            ...
            'AgentX伸手触碰异兽的（安全部位），手指在接触的瞬间微微颤抖——不是害怕，是能量共振的电流感。指尖感受到异兽体内流动的磁场温度，比自己的体温高了5度，手指本能地蜷缩又舒展，像试探温泉。眼睛微微睁大，瞳孔在接触点聚焦，嘴角从紧张变成纯粹的惊奇',
            // 动作2：额头相抵 + 心跳同步反应 + 信任落点
            'AgentX把额头轻轻抵在异兽身上，闭上眼睛，嘴角带着最纯粹的笑容。异兽的心跳（或能量脉动）通过接触点传递过来——沉稳、缓慢、有力。AgentX的呼吸节奏不自觉地开始同步，三秒一吸，三秒一呼。睫毛在接触点轻轻颤动，像蝴蝶停在一朵花上',
            // 动作3：环抱 + 毛发/能量纹理反应 + 归属落点
            'AgentX跳起来，双手环住异兽的（适合拥抱的部位），像拥抱一棵大树那样紧紧贴着。异兽的（毛发/能量纹理）蹭过他脸颊，他侧头蹭了蹭，像小猫在标记领地。闭上眼睛，嘴角上扬，整个身体的重量都挂在异兽身上——完全的信任和归属'
          ],
          microExpressions: [
      ...
      climax: {
        ...
        relief: {
          actions: [
            'AgentX叉腰仰头，对着双恒星哈哈大笑，笑声在Nirath磁场中回荡',
            'AgentX躺在草地上，四肢舒展成"大"字，胸口起伏，脸上挂着满足的微笑',
            'AgentX单脚站立，另一只脚向后翘起，双手展开保持平衡，像只骄傲的小鹤'
          ],
          microExpressions: [
            '眼睛弯成月牙，眼角有细细的纹路',
            '嘴巴张开大笑，露出整齐的小牙齿'
        ...
        awe: {
          actions: [
            'AgentX双手合十放在胸前，仰头闭目，像在祈祷又像在感谢',
            'AgentX单膝跪地，一只手撑地，另一只手轻轻放在胸口，低头致敬',
            'AgentX站在原地不动，只有头发和衣角在磁场风中飘动，眼神深邃如星空'
          ],
          microExpressions: [
            '眼神深邃，瞳孔中倒映着双恒星',
            '嘴角微微上扬，带着理解的微笑'
