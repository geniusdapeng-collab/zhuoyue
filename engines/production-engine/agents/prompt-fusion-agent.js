...
class PromptFusionAgent extends BaseAgent {
  constructor(options = {}) {
    super({ name: 'PromptFusionAgent', enabled: true, llmTimeout: TIMEOUTS.LLM.PROMPT_FUSION, ...options });
...
// ...
    ...
    this.llmTimeout = TIMEOUTS.LLM.PROMPT_FUSION; // 结构化输出需要更长时间
...
14. 【定妆照】：角色定妆照引用路径（如：image://characters/example-character/portraits/example-character-front.png）
  ...
  "shots": [
    {
      ...
      "fields": {
        ...
        "portraits": "image://characters/example-character/portraits/example-character-front.png",
